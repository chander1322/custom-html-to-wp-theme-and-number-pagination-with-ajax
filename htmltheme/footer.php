...
<footer class="w3l-footer py-5">
  <div class="container pt-lg-5 pt-md-3">
    ...
    <div class="row mt-5">
      ...
      <div class="col-lg-3 mb-lg-0 mb-5 footer-top">
      ...
      <div class="col-lg-3 mb-lg-0 mb-5 footv3-left">
      ...
      <div class="col-lg-3 mb-lg-0 mb-5">
        <h4 class="mb-4  w3f_title text-uppercase">Categories</h4>
      ...
      <div class="col-lg-3 mb-lg-0 mb-5">
        <h4 class="mb-4  w3f_title text-uppercase">Account</h4>
    ...
    <section class="w3l-footer-29-main w3l-copyright">
      <div class="text-center">
        <p class="copy-footer-29"><?php echo '@'.date('Y');?> <a href="#"
            target="_blank">
            Custom Theme</a></p>
      </div>
    </section>
